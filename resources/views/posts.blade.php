<x-layout>
    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-4 lg:px-0">
        <div class="grid gap-2 lg:grid-cols-3 md:grid-cols-2">
            @forelse ($posts as $post)
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <a href="/posts/{{ $post->slug }}">
                        <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ Str::limit($post->title, 28) }}</h2>
                    </a>
            ...
            @empty
                <div class="">
                    <p class="text-xl my-4 font-semibold text-red-500">Article Not Found</p>
